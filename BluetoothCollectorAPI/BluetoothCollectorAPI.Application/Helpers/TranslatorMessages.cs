...
namespace BluetoothCollectorAPI.Application.Helpers
{
    public static class TranslatorMessages
    {
        public static class AccountMessages
        {
            public static TranslatorMessageDto Account_notfound_with_Email(string userName) => new(nameof(Account_notfound_with_Email), [userName]);
